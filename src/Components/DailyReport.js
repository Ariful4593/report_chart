...
const DailyReport = () => {
    ...
    useEffect(() => {
        ...
        const cmt_18_19_sec_A = report.filter(elem => elem.dept === current && elem.section === 'A' && elem.session === '18-19')

        const cmt_18_19_sec_B = report.filter(elem => elem.dept === current && elem.section === 'B' && elem.session === '18-19')

        const cmt_19_20_sec_A = report.filter(elem => elem.dept === current && elem.section === 'A' && elem.session === '19-20')

        const cmt_19_20_sec_B = report.filter(elem => elem.dept === current && elem.section === 'B' && elem.session === '19-20')

        const cmt_20_21_sec_A = report.filter(elem => elem.dept === current && elem.section === 'A' && elem.session === '20-21')

        const cmt_20_21_sec_B = report.filter(elem => elem.dept === current && elem.section === 'B' && elem.session === '20-21')

        const cmt_21_22_sec_A = report.filter(elem => elem.dept === current && elem.section === 'A' && elem.session === '21-22')

        const cmt_21_22_sec_B = report.filter(elem => elem.dept === current && elem.section === 'B' && elem.session === '21-22')
    ...
    return (
        <div className='container mt-4'>
            <div className='row'>
                <select className="form-select" aria-label="Default select example" onChange={(e) => setCurrent(e.target.value)}>
                ...
                <div className="card col-md-6">
                    <div className='row'>
                        <div className='col-md-6'>
                            <div className="card-body">
                                ...
                                <h6 className="card-subtitle mb-2 text-muted">Session:  18-19</h6>
                                <h6 className="card-subtitle mb-2 text-muted">Section:  {`${current}`}-A</h6>
                                <h6 className="card-subtitle mb-2 text-muted">Total Student:
                                    {
                                        (report.filter(item => item.dept === current && item.section === 'A' && item.session === "18-19")).length
                                    }</h6>
                                <h6 className="card-subtitle mb-2 text-muted">Today Present: {
                                    (computer_A_18_19.filter(item => item.status === "Present")).length}</h6>
                                <h6 className="card-subtitle mb-2 text-muted">Today Absent: {
                                    (((report.filter(item => item.dept === current && item.section === 'A' && item.session === "18-19")).length) - (computer_A_18_19.filter(item => item.status === "Present")).length)}</h6>
                            </div>
                        </div>
                        <div className='col-md-6'>
                            <div className="card-body">
                                <PieChart width={100} height={200}>
                                    <Pie
                                        ...
                                        data={[
                                            { name: 'Total Student ', value: (report.filter(item => item.dept === current && item.section === 'A' && item.session === "18-19")).length },
                                            { name: 'Today Present ', value: (computer_A_18_19.filter(item => item.status === "Present")).length },
                                            { name: 'Today Absent ', value: (((report.filter(item => item.dept === current && item.section === 'A' && item.session === "18-19")).length) - (computer_A_18_19.filter(item => item.status === "Present")).length) },
                                        ]}
                                        cx="50%"
                                        cy="50%"
                                        outerRadius={80}
                    ...
                    <div className='row'>
                        <div className='col-md-6'>
                            <div className="card-body">
                                <h5 className="card-title">Department: {current}</h5>
                                <h6 className="card-subtitle mb-2 text-muted">Session:  18-19</h6>
                                <h6 className="card-subtitle mb-2 text-muted">Section:  {`${current}`}-B</h6>
                                <h6 className="card-subtitle mb-2 text-muted">Total Student:
                                    {
                                        (report.filter(item => item.dept === current && item.section === 'B' && item.session === "18-19")).length
                                    }</h6>
                                <h6 className="card-subtitle mb-2 text-muted">Today Present: {
                                    (computer_B_18_19.filter(item => item.status === "Present")).length}</h6>
                                <h6 className="card-subtitle mb-2 text-muted">Today Absent: {
                                    (((report.filter(item => item.dept === current && item.section === 'B' && item.session === "18-19")).length) - (computer_B_18_19.filter(item => item.status === "Present")).length)}</h6>
                            </div>
                        </div>
                        <div className='col-md-6'>
                            <div className="card-body">
                                <PieChart width={100} height={200}>
                                    <Pie
                                        ...
                                        isAnimationActive={false}
                                        data={[
                                            { name: 'Total Student ', value: (report.filter(item => item.dept === current && item.section === 'B' && item.session === "18-19")).length },
                                            { name: 'Today Present ', value: (computer_B_18_19.filter(item => item.status === "Present")).length },
                                            { name: 'Today Absent ', value: (((report.filter(item => item.dept === current && item.section === 'B' && item.session === "18-19")).length) - (computer_B_18_19.filter(item => item.status === "Present")).length) },
                                        ]}
                                        cx="50%"
                                        cy="50%"
                                        outerRadius={80}
                    ...
                    <div className='row'>
                        <div className='col-md-6'>
                            <div className="card-body">
                                <h5 className="card-title">Department: {current}</h5>
                                <h6 className="card-subtitle mb-2 text-muted">Session:  19-20</h6>
                                <h6 className="card-subtitle mb-2 text-muted">Section:  {`${current}`}-A</h6>
                                <h6 className="card-subtitle mb-2 text-muted">Total Student:
                                    {
                ...
                <div className="card col-md-6">
                    <div className='row'>
                        <div className='col-md-6'>
                            <div className="card-body">
                                ...
                                <h6 className="card-subtitle mb-2 text-muted">Total Student:
                                    {
                                        (report.filter(item => item.dept === current && item.section === 'A' && item.session === "20-21")).length
                                    }</h6>
                                <h6 className="card-subtitle mb-2 text-muted">Today Present: {
                                    (computer_A_20_21.filter(item => item.status === "Present")).length}</h6>
                                <h6 className="card-subtitle mb-2 text-muted">Today Absent: {
                                    (((report.filter(item => item.dept === current && item.section === 'A' && item.session === "20-21")).length) - (computer_A_20_21.filter(item => item.status === "Present")).length)}</h6>
                            </div>
                        </div>
                        <div className='col-md-6'>
                            <div className="card-body">
                    ...
                    <div className='row'>
                        <div className='col-md-6'>
                            <div className="card-body">
                                ...
                                <h6 className="card-subtitle mb-2 text-muted">Total Student:
                                    {
                                        (report.filter(item => item.dept === current && item.section === 'B' && item.session === "20-21")).length
                                    }</h6>
                                <h6 className="card-subtitle mb-2 text-muted">Today Present: {
                                    (computer_B_20_21.filter(item => item.status === "Present")).length}</h6>
                                <h6 className="card-subtitle mb-2 text-muted">Today Absent: {
                                    (((report.filter(item => item.dept === current && item.section === 'B' && item.session === "20-21")).length) - (computer_B_20_21.filter(item => item.status === "Present")).length)}</h6>
                            </div>
                        </div>
                        <div className='col-md-6'>
                            <div className="card-body">
                    ...
                    <div className='row'>
                        <div className='col-md-6'>
                            <div className="card-body">
                                <h5 className="card-title">Department: {current}</h5>
                                <h6 className="card-subtitle mb-2 text-muted">Session:  21-22</h6>
                                <h6 className="card-subtitle mb-2 text-muted">Section:  {`${current}`}-A</h6>
                                <h6 className="card-subtitle mb-2 text-muted">Total Student:
                                    {
                                        (report.filter(item => item.dept === current && item.section === 'A' && item.session === "21-22")).length
                                    }</h6>
                                <h6 className="card-subtitle mb-2 text-muted">Today Present: {
                                    (computer_A_21_22.filter(item => item.status === "Present")).length}</h6>
                                <h6 className="card-subtitle mb-2 text-muted">Today Absent: {
                                    (((report.filter(item => item.dept === current && item.section === 'A' && item.session === "21-22")).length) - (computer_B_21_22.filter(item => item.status === "Present")).length)}</h6>
                            </div>
                        </div>
                        <div className='col-md-6'>
                            <div className="card-body">
                    ...
                    <div className='row'>
                        <div className='col-md-6'>
                            <div className="card-body">
                                ...
                                <h6 className="card-subtitle mb-2 text-muted">Total Student:
                                    {
                                        (report.filter(item => item.dept === current && item.section === 'B' && item.session === "21-22")).length
                                    }</h6>
                                <h6 className="card-subtitle mb-2 text-muted">Today Present: {
                                    (computer_A_21_22.filter(item => item.status === "Present")).length}</h6>
                                <h6 className="card-subtitle mb-2 text-muted">Today Absent: {
                                    (((report.filter(item => item.dept === current && item.section === 'B' && item.session === "21-22")).length) - (computer_B_21_22.filter(item => item.status === "Present")).length)}</h6>
                            </div>
                        </div>
                        <div className='col-md-6'>
                            <div className="card-body">
